...
> Component：`WL-TOPIC-QT821-WORLD-PARENTS-SEPARATION`
>
> component_type：`plot_pattern`
>
> Baseline：`QT8.2_PLOT_PATTERN_TEMPLATE_V1_FROZEN`

---

## 1. Acceptance summary

本组件通过 QT8.2 V1 冻结后的正式 component acceptance。

```text
QT8.2.1_P1_COMPONENT_ACCEPTANCE = PASS
QT8.2.1_P1_COMPONENT_TYPE = plot_pattern
QT8.2.1_P1_STATUS = ACTIVE_V1_COMPONENT
...
```text
QT8.2_FIRST_REAL_COMPONENT_RELATION_GATE = PASS
QT8.2_SHARED_DATA_V1_AMENDMENT_REQUIRED = NO
```
...
QT8.2.1_P1_COMPONENT_ACCEPTANCE = PASS
QT8.2.1_P1_STATUS = ACTIVE_V1_COMPONENT
QT8.2.1_ACTIVE_COMPONENT_COUNT_AFTER_P1 = 2

QT8.2_FIRST_REAL_CROSS_TYPE_COMPONENT_RELATION = AUTHORIZED_TO_CREATE
QT8.2_TEMPLATE_V1_REOPEN = NO
```

下一步：创建 P1 → M2 `carries_motif` 原子关系记录，并同步专题主页、数据索引与 QT8.2.1 问题域状态。