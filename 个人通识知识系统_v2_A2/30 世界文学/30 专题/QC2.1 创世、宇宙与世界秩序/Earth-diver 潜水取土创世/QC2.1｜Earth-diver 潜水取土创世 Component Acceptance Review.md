# QC2.1｜Earth-diver / 潜水取土创世 Component Acceptance Review
...
→ QC2.2 primary scope by default
```

洪水后 Earth-diver 不用于膨胀 QC2.1 核心 source count。
...
QC2_MOTIF_TEMPLATE_V1 = COMPATIBLE
...
```text
QC2.1_M5_COMPONENT_ACCEPTANCE = PASS
QC2.1_M5_STATUS = ACTIVE_V1_COMPONENT
QC2.1_M5_COMPONENT_TYPE = motif
QC2.1_M5_SOURCE_REFERENCE_COUNT = 2
QC2.1_M5_COMPONENT_RELATION_COUNT = 0
QC2.1_M5_WORK_REFERENCE_COUNT = 0
QC2_TEMPLATE_REOPEN_REQUIRED = NO
```
...
```text
QC2.1_TARGETED_COMPONENT_GAP_M5 = CLOSED
```

因此下一阶段不再机械顺延 M6 / P2 / A1 / A2；应执行 QC2.1 Stage Content Freeze Review，判断该问题域能否以 6 个 active components 阶段性收束。
