# QC2.1｜M5 Earth-diver / 潜水取土创世 Admission Research

> 目标：判断 Earth-diver 是否应作为 QC2.1 的独立 motif component 准入。
>
...
→ primary cluster: QC2.1

post-catastrophe land re-creation
→ primary cluster: QC2.2 毁灭、灾变与世界重生
```
...
must NOT be used to inflate QC2.1 source count
```

这解决了 QC2.1 / QC2.2 域污染风险。
...
```text
QC2.1_M5_ADMISSION_RESEARCH = PASS
QC2.1_M5_COMPONENT_TYPE = motif
QC2.1_M5_REQUIRED_INVARIANTS = STABLE
QC2.1_M5_CROSS_TRADITION_PRESSURE = PASS
QC2.1_M5_PRIMORDIAL_VS_POST_FLOOD_BOUNDARY = PASS
QC2.1_M5_VS_M2_BOUNDARY = PASS
QC2.1_M5_VS_M3_BOUNDARY = PASS
QC2.1_M5_VS_S2_BOUNDARY = PASS
QC2.1_M5_INCREMENTAL_EXPLANATORY_VALUE = HIGH
QC2.1_M5_PROMOTE_TO_TOPIC_BUILD_QUEUE = YES
...
不得把 post-flood Great Plains retelling 当作 QC2.1 的核心 defining source。
...
只有 Topic Build + Component Acceptance 通过后，M5 才成为 QC2.1 第六个 active component。
