...
4 条 `qc2_source_reference` 均有明确 `source_status` 与 `tradition_role`。
...
```text
qc2_component_relation = 0 new records
```
...
```text
QC2.1_M3_COMPONENT_ACCEPTANCE = PASS
QC2.1_M3_COMPONENT_TYPE = motif
QC2.1_M3_STATUS = ACTIVE_V1_COMPONENT
QC2.1_M3_SOURCE_REFERENCE_COUNT = 4
QC2.1_M3_COMPONENT_RELATION_COUNT = 0
QC2.1_M3_WORK_REFERENCE_COUNT = 0
QC2_TEMPLATE_REOPEN_REQUIRED = NO
```

M3 可正式登记为 QC2.1 第四个 active V1 component。