...
>
> 验证基准：[[个人通识知识系统_v2_A2/30 世界文学/30 专题/CN2.3 神、人边界与禁忌越界/巴别塔/CN2｜Pilot D 巴别塔 Acceptance Review]]
>
> 前置治理：[[CN2｜世界文化母题、原型与叙事结构模板总则 V0]] + [[CN2｜共享数据层规范 V0]]
...
若只满足“故事里出现过”，保持为 source object，不进入 CN2 symbol。
...
按 CN1.1 记录来源，并继承共享 `source_status`：
...
正式关系使用共享 `qc2_component_relation`，只有 target 已完成自身准入且关系有实际解释价值时才创建。
...
CN2_REFERENCE_SYMBOL = WL-TOPIC-CN23-BABEL
