---
id: WL-TEMPLATE-CN2-COMPONENT-V1
type: literature_topic_template
name: CN2 组件型专题地图模板 V1
status: FROZEN_V1
validated_by:
  - 洪水与灾后重建 (motif)
...
> 适用范围：CN2 的正式 `motif / archetype / plot_pattern / symbol` 组件。CN2 不套用 CN1 的传统型模板：CN1 回答“从哪套传统来”，CN2 回答“跨传统反复出现了什么叙事组件”。
...
`theme` 不作为 CN2 核心对象，仍主要属于 TH。

## 3. Cluster 与组件关系

- `CN2.1–CN2.20` 是一级问题域 / 导航 cluster，不是 component。
...
- `12 跨传统关系`：跨传统分布、相似/传播区分、与其他 CN2 对象关系。
