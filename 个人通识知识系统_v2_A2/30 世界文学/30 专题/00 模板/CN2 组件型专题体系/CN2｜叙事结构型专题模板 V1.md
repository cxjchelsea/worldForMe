...
> 对象类型：`plot_pattern`
>
> 状态：`CN2_PLOT_PATTERN_TEMPLATE_V1_FROZEN`
>
...
来源统一使用 `qc2_source_reference`，并记录实际节点序列、匹配程度与 source_status。
...
统一使用 `qc2_work_reference`，并允许 plot-pattern-specific optional fields：
