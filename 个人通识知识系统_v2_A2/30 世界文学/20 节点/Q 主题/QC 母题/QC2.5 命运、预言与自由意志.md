...
anchorable: true
topic_map: "../../../30 专题/QC2.5 命运、预言与自由意志/预言→逃避→实现/00 预言→逃避→实现.md"
...
→ [[../../../30 专题/QC2.5 命运、预言与自由意志/预言→逃避→实现/00 预言→逃避→实现|预言 → 逃避 → 实现]]
...
Acceptance Review：[[../../../30 专题/QC2.5 命运、预言与自由意志/预言→逃避→实现/QC2｜Pilot C 预言→逃避→实现 Acceptance Review|Pilot C Acceptance Review]]
