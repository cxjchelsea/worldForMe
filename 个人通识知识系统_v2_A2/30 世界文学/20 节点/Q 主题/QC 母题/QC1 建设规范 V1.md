...
> 本文件是 [[QC 总体架构与建设规范 V2]] 在 QC1 层的实施规范。它规定 QC1.1 与 QC1.2 的分工、资源对象、专题准入、证据记录、产品结构与冻结机制。
>
> QC1.1 的具体产品模板以 [[QC1.1 来源传统专题模板 V1]] 为准；QC1.2 的 `narrative_cycle` 具体产品模板以 [[QC1.2 narrative_cycle 专题模板 V1]] 为准。
...
QC1.2.2 已验证：一个中央 work 可以继续下钻到多个 `story_witness`，作品数量不是专题成熟度指标。
...
```text
QC1.2.1 特洛伊故事循环      → STAGE_FROZEN
QC1.2.2 沃尔松—尼伯龙根    → STAGE_FROZEN
```
...
1. **QC1.1 的 11 个来源 hubs 保持冻结**，不为全球覆盖继续扩表；
2. **QC1.1.1 与 QC1.1.2 继续作为 V1 冻结参考样板**；
3. 后续 QC1.1.3–QC1.1.11 按 [[QC1.1 来源传统专题模板 V1]] 升级；
4. **QC1.2.1 与 QC1.2.2 已完成 stage freeze**；
5. **[[QC1.2 narrative_cycle 专题模板 V1]] 已冻结**，后续 narrative_cycle 默认遵循该 V1，除非材料明确要求局部偏离；
6. 下一个 QC1.2 正式验证样板必须优先选择不同 resource_type，而不是继续建立第三个 narrative_cycle 来证明同一件事；
7. 当前首选 `figure_tradition`，候选为亚瑟王叙事传统；
8. 第三样板重点验证人物网络、子人物传统、多语言扩张与 12–13 职责是否需要调整；
9. 在 `figure_tradition / story_tradition / collection_tradition` 获得足够验证前，不宣布 QC1.2 全类型统一模板；
10. QC1.1 与 QC1.2 均通过网络关系连接 QC2，不追求目录树表达全部知识。
