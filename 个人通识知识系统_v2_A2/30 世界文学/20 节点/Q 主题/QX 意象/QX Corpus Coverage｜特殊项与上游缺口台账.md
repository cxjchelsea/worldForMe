...
| 读书记录 | 状态 | 当前结论 / QX 下一步 |
|---|---|---|
| 福尔摩斯探案全集 | ONE_TO_MANY_RECONCILIATION | 已完成 4 长篇 +《历险记》12篇 +《回忆录》11篇，共 27/60；剩余 33 短篇 |
...
SHERLOCK_UNITS_REVIEWED = 27
SHERLOCK_SHORT_STORIES_REVIEWED = 23
SHERLOCK_SHORT_STORIES_REMAINING = 33
SHERLOCK_FORMAL_RELATIONS_CURRENT = 44
```
...
2. SERIES / VOLUME GRANULARITY
   - 哈利·波特 → CLOSED
   - 福尔摩斯探案全集 → CURRENT / 27 OF 60 REVIEWED
     - 四部长篇 → CLOSED
     - 福尔摩斯历险记 → CLOSED
     - 福尔摩斯回忆录 → CLOSED
     - 福尔摩斯归来记 → NEXT
