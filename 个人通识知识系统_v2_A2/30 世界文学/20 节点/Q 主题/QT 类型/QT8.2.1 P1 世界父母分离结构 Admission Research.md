# QT8.2.1｜P1 世界父母分离结构｜Admission Research
...
>
> 基线：`QT8.2 Plot Pattern Template V1 FROZEN`
...
M2 已是正式 component，P1 目前仍处于 `ADMITTED_FOR_BUILD`，所以本研究阶段**仍不创建**正式 `qt82_component_relation`。
