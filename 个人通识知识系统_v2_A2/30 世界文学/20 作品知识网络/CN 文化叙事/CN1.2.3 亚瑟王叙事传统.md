...
CN1.2 的第一个 `figure_tradition` 冻结样板。
...
CN1.2.1、CN1.2.2 可以较强地通过故事区段、版本与分支组织；CN1.2.3 证明：
...
→ [[../../30 专题/CN1.2.3 亚瑟王叙事传统/00 亚瑟王叙事传统|CN1.2.3 亚瑟王叙事传统专题主页]]
...
CN1.2.3 已完成首个 `figure_tradition` 的完整验证。后续只在新阅读、重要新材料、证据修正或人物网络结构性缺口出现时 reopen，不再为了覆盖所有圆桌人物与现代改编机械扩充。
