...
---
# CN1.2 故事循环、人物传说与跨文本叙事传统

CN1.2 是 CN1 的**具体叙事传统层（cross-text narrative traditions）**。
...
```text
亚瑟王传统 → CN1.2 figure_tradition
圣杯故事传统 → 可评估 CN1.2 story_tradition
圣杯 symbol → CN2
神圣目标求索 → CN2
```

```text
《一千零一夜》集合传统 → CN1.2 collection_tradition
框架叙事 → CN2 narrative_structure
...
冻结模板：[[CN1.2 narrative_cycle 专题模板 V1]]
...
→ 人物与结构变体
→ 后世重构
→ CN2 / evidence / reading
```

## 4. figure_tradition V1

参考样板：[[CN1.2.3 亚瑟王叙事传统]]

冻结模板：[[CN1.2 figure_tradition 专题模板 V1]]
...
参考样板：[[CN1.2.4 一千零一夜故事集合与传播传统]]

冻结模板：[[CN1.2 collection_tradition 专题模板 V1]]
...
4. 演变谱系本身具有解释价值；
5. 有重要跨语言／地域／文类／媒介生命；
6. 对多部作品或多个 CN2 组件有解释复用价值。

仅仅“故事很有名”不足以准入。

## 8. 当前正式专题

- [[CN1.2.1 特洛伊故事循环]] — `narrative_cycle` — `STAGE_FROZEN`
- [[CN1.2.2 沃尔松—尼伯龙根叙事传统]] — `narrative_cycle` — `STAGE_FROZEN`
- [[CN1.2.3 亚瑟王叙事传统]] — `figure_tradition` — `STAGE_FROZEN`
- [[CN1.2.4 一千零一夜故事集合与传播传统]] — `collection_tradition` — `STAGE_FROZEN`
...
> 上级：[[CN1 世界文化叙事传统|CN1 世界叙事资源与来源传统]]  
> 同级：[[CN1.1 神话、传说与民间叙事|CN1.1 神话、宗教与民间叙事来源传统]]  
> 候选池：[[CN1.2 候选叙事传统池 V1]]  
> narrative_cycle：[[CN1.2 narrative_cycle 专题模板 V1]]  
> figure_tradition：[[CN1.2 figure_tradition 专题模板 V1]]  
> collection_tradition：[[CN1.2 collection_tradition 专题模板 V1]]  
> 专属治理：[[CN1 建设规范 V1]]  
