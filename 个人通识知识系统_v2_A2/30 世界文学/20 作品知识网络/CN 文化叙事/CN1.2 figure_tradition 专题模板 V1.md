---
id: WL-CN12-FIGURE-TRADITION-TEMPLATE-V1
legacy_id: WL-CN12-FIGURE-TRADITION-TEMPLATE-V1
...
validated_by:
  - WL-CN1.2.3
---
# CN1.2 figure_tradition 专题模板 V1

> 本模板由 [[CN1.2.3 亚瑟王叙事传统]] 作为首个 `figure_tradition` 异质样板验证。
>
...
- `independent_candidate`：已具备独立 CN1.2 准入可能，应单独做 source readiness。
