...
> 本文件定义 CN 的长期职责、三层架构、对象模型、关系与证据规则、跨轴边界，以及专题准入、建设、冻结与重开机制。它是 CN 后续扩展的治理依据，不承担具体知识内容。

## 0. CN 的总定义

**CN｜世界叙事资源、母题谱系与文化传统**：研究故事从何而来，哪些叙事组件在不同文本与文化中反复出现、传播和变形，以及这些资源与组件如何进入具体历史社会，形成稳定的文化角色、叙事世界与文学传统。

CN 不以穷尽神话、母题或文化符号为目标，而以建立一个能够解释经典文学、民间叙事及现代再创作的高复用叙事资源网络为目标。
...
CN1 回答：**一个叙事资源从哪里来，它如何形成、保存、文本化、经典化、传播和被后世重写。**

CN1 的核心不是“文明百科”，而是建立可追踪的叙事资源谱系。

现有按文明／传统组织的 CN1.1 叶节点继续保留，作为来源传统 hub 和导航入口；不因新故事增加而无限追加 taxonomy 层级。
...
资源对象原则上进入专题数据层或实体层，不要求全部升格为正式 CN 编号。
...
CN2 回答：**哪些叙事组件被反复使用，它们如何组合、传播、反转、重写，以及哪些相似只是独立同构。**

现有 CN2.1—CN2.20 继续作为相对稳定的问题域／母题簇，不要求每个具体对象都成为新的 taxonomy 节点。
...
`theme` 回答“作品在讨论什么抽象问题”，继续主要由 TH 承担。CN2 可与 TH 建立关系，但不重复建设主题 taxonomy。

## 3.3 Component 建设标准

CN2.1 已验证的 component 机制推广为 CN2 通用标准。一个正式 component 至少需要：
...
CN3 研究：**叙事资源和组件如何在具体历史社会中，与制度、阶层、伦理、政治合法性、空间经验和媒介传统结合，形成持续被重写的文化角色、社会想象和叙事世界。**

CN3 不是“某国文化概论”，也不是文学类型目录。
...
CN1 来源叙事与历史材料
        +
CN2 母题 / character types / plot patterns / symbols
        +
社会制度
        +
阶层结构
...
CN3 的核心是“历史化组织”，不是寻找所有传统背后的单一原型。
...
12. 与 TY 类型、TH 主题、R 区域文学及具体作品的关系
13. 跨文化比较
14. 阅读路线与支撑书目
```
...
复仇 → CN2
侦探小说 → TY
浮士德 → CN1 + CN2，通常不单独进入 CN3
骑士传统 → CN3 候选
侠／江湖传统 → CN3 候选，并与 TY 武侠类型建立映射
```
...
CN1、CN2、CN3 必须通过关系共享同一批故事、人物、文本和作品，不允许为了满足三个专题模板而复制三份事实。
...
普罗米修斯故事
CN1 → 希腊来源、早期见证、文本定型
CN2 → 盗火、越界获取知识、神罚、named_archetype
TH  → 知识、自由、责任、权力
...
| 系统 | 核心问题 | CN 不应重复的内容 |
|---|---|---|
| CN1 | 这个故事从哪里来、怎样形成与传播？ | 不写区域文学通史 |
| CN2 | 哪些叙事组件反复出现、怎样变形？ | 不把抽象主题重新做成母题 |
| CN3 | 组件如何在历史社会中形成文化叙事传统？ | 不把文化传统等同于文学类型 |
| TH | 作品讨论什么主题／观念问题？ | CN 只建立关联 |
| TY | 文学类型如何形成、运作并产生惯例？ | CN3 不复制 genre history |
| R | 某地区文学如何历史发展？ | CN1/3 只取与叙事传统有关部分 |
| T | 某时期文学如何变化？ | CN 不承担完整时期史 |
| 40 作品 | 具体作品是什么、怎样阅读？ | CN 保存关系，不复制作品实体 |

### CN3 与 TY 的硬边界

```text
CN3 问：为什么一个社会形成“侠、骑士、武士、cowboy”等文化角色与叙事世界？
TY 问：武侠小说、西部片／西部小说等作为文学／媒介类型如何运作？
```
...
```text
Phase 1｜冻结本治理规范与 CN 顶层三层定义

Phase 2｜从 CN2.1 提炼并正式固化 Component 模板

Phase 3｜以“希腊—罗马神话传统”重构一个 CN1 深建样板

Phase 4｜建立 CN3 Pilot：英雄、武人、边疆与法外者文化传统
         首批比较：侠 / 骑士 / 武士 / 西部
...
第一阶段不要求同时补全所有 CN1 来源传统，也不要求依次完成 CN2.2—CN2.20。
...
CN 的完成不以“收录多少神话、多少母题、多少人物”衡量，而以以下能力衡量：
...
5. 能与 TH、TY、R、T、40 作品连接而不复制它们的职责；
