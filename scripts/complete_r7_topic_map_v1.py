...
('非洲之角—埃塞俄比亚/厄立特里亚/索马里文学传统','现代埃塞俄比亚小说','爱到坟墓|Love unto Crypt|Fikir Eske Mekabir','★'),
('非洲之角—埃塞俄比亚/厄立特里亚/索马里文学传统','索马里口传诗','哈德拉维诗选|Hadraawi','★'),
('非洲之角—埃塞俄比亚/厄立特里亚/索马里文学传统','索马里现代小说','弯曲的肋骨|From a Crooked Rib','★'),
('非洲之角—埃塞俄比亚/厄立特里亚/索马里文学传统','索马里国家崩解','地图|Maps','◆'),
('非洲之角—埃塞俄比亚/厄立特里亚/索马里文学传统','埃塞俄比亚革命/流亡','切割石头|Cutting for Stone','◆'),
