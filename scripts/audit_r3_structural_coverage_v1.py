...
('泰米尔与南印度文学传统','泰米尔史诗','西拉巴提伽拉姆|Silappatikaram','P0'),
...
('泰米尔与南印度文学传统','马拉雅拉姆现代小说','山羊的一生|Pathummayude Aadu|Chemmeen|虾','P1'),
('泰米尔与南印度文学传统','现代泰米尔文学','火焰|Samskara|Ponniyin Selvan','P1'),
...
('北印度俗语—Bhakti与印地文学传统','印地短篇现实主义','棋手|Premchand short stories|两个公牛','P1'),
...
('孟加拉与东部语言文学传统','孟加拉小说形成','毒树|Anandamath|阿难陀寺','P1'),
('孟加拉与东部语言文学传统','泰戈尔诗歌','吉檀迦利|Gitanjali','P0'),
('孟加拉与东部语言文学传统','泰戈尔小说','家庭与世界|Ghare-Baire|戈拉','P1'),
('孟加拉与东部语言文学传统','孟加拉现实主义小说','斯里坎特|Pather Panchali|道路之歌','P1'),
...
('旁遮普—信德与西北文学传统','旁遮普分治文学','针陀与其他故事|Pinjar|骨笼','P1'),
...
('僧伽罗—斯里兰卡文学传统','斯里兰卡英语/战争文学','英国病人|Anil’s Ghost|安尼尔的鬼魂','P1'),
...
('南亚英语文学传统','印度英语地方小说','马尔古迪的日子|Swami and Friends|斯瓦米和朋友','P1'),
('南亚英语文学传统','后殖民英语小说','午夜之子|Midnight’s Children','P0'),
